	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Pembelian Tiket LIGA 2</h1>
					<nav class="d-flex align-items-center">
						<a href="index.html">pesan<span class="lnr lnr-arrow-right"></span></a>
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false" aria-controls="fruitsVegetable"><span
							...
							<ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false" aria-controls="fruitsVegetable">
								...
								<li class="main-nav-list child"><a href="kategori1.php">Beli Tiket Liga 2</a></li>
							</ul>
						</li>
...
if ($_GET)
    {
        $cari=$_GET['cari'];
        $query = mysqli_query($mysqli,"SELECT * FROM pertandingan where liga = 'liga2' and partai_pertandingan  like '%$cari%' OR harga_tiket like '%$cari%'");
        }else{
